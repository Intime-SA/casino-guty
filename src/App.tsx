...
import { GiPokerHand, GiCardAceSpades, GiCardJoker, GiDiamonds, GiSpades, GiHearts, GiClubs, GiLaurels } from 'react-icons/gi';
import { MdCasino, MdSportsBasketball, MdDevices, MdCheckCircle, MdChevronLeft, MdChevronRight } from 'react-icons/md';
import { FaDice, FaCoins, FaUsers, FaGift, FaMobileAlt, FaRegIdCard } from 'react-icons/fa';
...
// Testimonial Data
const testimonials = [
    { name: "Diego", age: 28, quote: "Me enganché con las dinámicas desde el día uno. ¡Súper entretenido!" },
    { name: "Camila", age: 34, quote: "No esperaba que fuera tan simple empezar. Me gustó la interfaz y la comunidad." },
    { name: "Leo", age: 41, quote: "Lo mejor: los desafíos y los logros que se desbloquean cada semana." },
    { name: "Ana", age: 25, quote: "La variedad de actividades es genial, siempre hay algo nuevo para hacer." },
    { name: "Marcos", age: 30, quote: "¡Excelente plataforma! Muy intuitiva y las recompensas valen la pena." },
];
                    ...
                    {testimonials.map((testimonial, index) => (
                        <div key={index} className="w-full flex-shrink-0 px-4">
                            ...
                            >
                                ...
                                <p className="text-brand-green font-semibold">{testimonial.name}, {testimonial.age}</p>
                            </motion.div>
                        </div>
                    ))}
                </motion.div>
    ...
    <div className="min-h-screen w-full bg-[#212121] text-white relative overflow-hidden font-special-gothic">
      ...
      <main className="relative z-10 pt-24 md:pt-32 pb-16">
        ...
        >
          ...
          >
            Explorá la mejor plataforma de <span className="text-brand-green">entretenimiento digital</span>
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-8"
          >
            Beneficios exclusivos al registrarte hoy. Sumate a miles de usuarios y descubrí una nueva forma de jugar y ganar.
          </motion.p>
        ...
        <section className="px-4 py-12 md:py-16 bg-gradient-to-br from-[#2a2a2a] via-[#212121] to-[#2a2a2a]">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-brand-green mb-4 leading-tight">¡DUPLICAMOS TU PRIMER DEPÓSITO!</h2>
              <p className="text-white/90 text-xl md:text-2xl font-semibold mb-6">
                 Recibí hasta <span className="text-white font-bold">$250.000</span> extra para empezar con todo.
              </p>
              <div className="flex flex-col items-center md:items-start gap-4">
                 <LoadingButton href={REGISTER_URL} variant="primary" className="shadow-brand-green/40 w-full sm:w-auto">
        ...
        >
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                {[
                    { icon: FaGift, title: "Bonificaciones Exclusivas", desc: "Beneficios especiales solo para nuevos usuarios." },
                    { icon: GiLaurels, title: "Actividades Únicas", desc: "Dinámicas interactivas que no encontrarás en otro lugar." },
                    { icon: FaRegIdCard, title: "Acceso Inmediato", desc: "Registrate fácilmente solo con tu documento." },
                    { icon: MdDevices, title: "Multiplataforma", desc: "Disfrutá desde cualquier dispositivo, donde sea." },
                ].map((item, index) => (
                    <motion.div
                        key={index}
                        variants={fadeInUp}
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
           <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-4">
             ...
             <a href="#" className="text-white/70 hover:text-brand-green transition-colors duration-200 text-sm">Política de Privacidad</a>
             <span className="text-white/30 hidden sm:inline">|</span>
             <a href="#" className="text-white/70 hover:text-brand-green transition-colors duration-200 text-sm">Juego Responsable</a>
           </div>
          ...
          <div className="text-center text-white/60 text-xs md:text-sm max-w-2xl mx-auto">
            ...
            <p>
              El acceso a esta plataforma está destinado a mayores de 18 años. Promovemos el uso responsable y consciente del tiempo en línea. Jugar compulsivamente puede ser perjudicial para la salud.
            </p>
            <p className="mt-4 text-white/40 text-xs">
              © {new Date().getFullYear()} Sportsbet. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </motion.footer>
